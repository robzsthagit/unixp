module Redis::RedisKeys
  ...
  UNIXP_INSTALLATION_ONBOARDING = 'UNIXP_INSTALLATION_ONBOARDING'.freeze
  UNIXP_INSTALLATION_CONFIG_RESET_WARNING = 'UNIXP_CONFIG_RESET_WARNING'.freeze
  LATEST_UNIXP_VERSION = 'LATEST_UNIXP_VERSION'.freeze
