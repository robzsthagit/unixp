module Enterprise::Account::PlanUsageAndLimits # rubocop:disable Metrics/ModuleLength
  ...
  def email_transcript_enabled?
    default_plan = InstallationConfig.find_by(name: 'UNIXP_CLOUD_PLANS')&.value&.first
  ...
  def subscribed_features
    plan_features = InstallationConfig.find_by(name: 'UNIXP_CLOUD_PLAN_FEATURES')&.value
  ...
  def default_captain_limits
    max_limits = { documents: UniXPApp.max_limit, responses: UniXPApp.max_limit }.with_indifferent_access
