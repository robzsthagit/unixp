module Enterprise::SuperAdmin::AppConfigsController
  ...
  def allowed_configs
    return super if UniXPHub.pricing_plan == 'community'
  ...
  def internal_config_options
    %w[UNIXP_INBOX_TOKEN UNIXP_INBOX_HMAC_KEY CLOUD_ANALYTICS_TOKEN CLEARBIT_API_KEY CONTEXT_DEV_API_KEY DASHBOARD_SCRIPTS
       INACTIVE_WHATSAPP_NUMBERS SKIP_INCOMING_BCC_PROCESSING CAPTAIN_CLOUD_PLAN_LIMITS MARKETING_CONVERSION_TRACKING_CONFIG
       ACCOUNT_SECURITY_NOTIFICATION_WEBHOOK_URL UNIXP_INSTANCE_ADMIN_EMAIL OG_IMAGE_CDN_URL OG_IMAGE_CLIENT_REF CLOUDFLARE_API_KEY
