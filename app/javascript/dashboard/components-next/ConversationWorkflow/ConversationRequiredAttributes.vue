...
const { t } = useI18n();
const { currentAccount, accountId, isOnUniXPCloud, updateAccount } =
  useAccount();
...
const showPaywall = computed(() => !props.isEnabled && isOnUniXPCloud.value);
const i18nKey = computed(() =>
  isOnUniXPCloud.value ? 'PAYWALL' : 'ENTERPRISE_PAYWALL'
);
...
<template>
  ...
  >
    ...
    <BasePaywallModal
      ...
      :i18n-key="i18nKey"
      :is-on-unixp-cloud="isOnUniXPCloud"
