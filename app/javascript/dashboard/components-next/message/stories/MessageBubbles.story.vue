...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about UniXP?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
...
const email = computed(() =>
  getMessage({
    ...
    attachments: [
      ...
      getAttachment('file', 'https://unixp.dev/invoice.pdf'),
      getAttachment('file', 'https://unixp.dev/logs.txt'),
      getAttachment('file', 'https://unixp.dev/contacts.xls'),
      getAttachment('file', 'https://unixp.dev/customers.csv'),
      getAttachment('file', 'https://unixp.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://unixp.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://unixp.dev/all-files.tar'),
      getAttachment(
        'audio',
