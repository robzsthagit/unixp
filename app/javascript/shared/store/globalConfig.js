...
const {
  ...
  UNIXP_INBOX_TOKEN: unixpInboxToken,
...
export const getters = {
  get: $state => $state,
  isOnUniXPCloud: $state => $state.deploymentEnv === 'cloud',
  isACustomBrandedInstance: $state => $state.installationName !== 'UniXP',
  isAUniXPInstance: $state => $state.installationName === 'UniXP',
};
