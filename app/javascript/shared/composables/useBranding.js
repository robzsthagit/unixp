...
export function useBranding() {
  ...
  /**
   * Replaces "UniXP" in text with the installation name from global config
   * @param {string} text - The text to process
   * @returns {string} - Text with "UniXP" replaced by installation name
   */
  const replaceInstallationName = text => {
    ...
    return text.replace(/UniXP/g, installationName);
  };
